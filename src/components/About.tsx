  ...
  return (
    <section id="about" className="py-20 bg-white">
      <div className="section-container">
        <h2 className="section-title" data-i18n="about.title">{title}</h2>
          ...
          <div className="flex justify-center">
            <div className="relative group">
              <div className="w-64 h-64 sm:w-72 sm:h-72 rounded-full overflow-hidden border-4 border-primary transform transition-transform duration-300 group-hover:-translate-y-2">
                <img 
                  src="https://img.freepik.com/vecteurs-libre/illustration-du-jeune-homme-aux-lunettes_1308-174706.jpg" 
                  alt="Profile" 
